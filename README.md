...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-libtfkernel_mlir_ops-green.svg)](https://anaconda.org/conda-forge/libtfkernel_mlir_ops) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/libtfkernel_mlir_ops.svg)](https://anaconda.org/conda-forge/libtfkernel_mlir_ops) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/libtfkernel_mlir_ops.svg)](https://anaconda.org/conda-forge/libtfkernel_mlir_ops) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/libtfkernel_mlir_ops.svg)](https://anaconda.org/conda-forge/libtfkernel_mlir_ops) |

Installing libtfkernel_mlir_ops
===============================

Installing `libtfkernel_mlir_ops` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Once the `conda-forge` channel has been enabled, `libtfkernel_mlir_ops` can be installed with `conda`:

```
conda install libtfkernel_mlir_ops
```

or with `mamba`:

```
mamba install libtfkernel_mlir_ops
```

It is possible to list all of the versions of `libtfkernel_mlir_ops` available on your platform with `conda`:

```
conda search libtfkernel_mlir_ops --channel conda-forge
```

or with `mamba`:

```
mamba search libtfkernel_mlir_ops --channel conda-forge
```
...
mamba repoquery search libtfkernel_mlir_ops --channel conda-forge

# List packages depending on `libtfkernel_mlir_ops`:
mamba repoquery whoneeds libtfkernel_mlir_ops --channel conda-forge

# List dependencies of `libtfkernel_mlir_ops`:
mamba repoquery depends libtfkernel_mlir_ops --channel conda-forge
```
...
Updating libtfkernel_mlir_ops-feedstock
=======================================

If you would like to improve the libtfkernel_mlir_ops recipe or build a new
...
Note that all branches in the conda-forge/libtfkernel_mlir_ops-feedstock are
