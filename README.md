...
Once the `conda-forge` channel has been enabled, `libtensorflow, libtensorflow_cc, tensorflow-base` can be installed with:

```
conda install libtensorflow libtensorflow_cc tensorflow-base
```
